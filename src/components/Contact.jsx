  ...
  return (
    ...
    >
     ...
     >
         ...
         I'm actively seeking   <span className='text-[#915EFF]'>opportunities</span> to apply my skills and expertise.
         </h1>
         <p className={`mt-2 text-white-100 md:ml-10`}>
         Feel free to reach out via the <span className='text-[#915EFF]'>contact form</span> or <span className='text-[#915EFF]'>connect</span> with me on <span className='text-[#915EFF]'>LinkedIn</span>,<br className='sm:block hidden' />
           or check out my <span className='text-[#915EFF]'>github</span> profile via  the button below!
         </p>
         <button onClick={() => window.location.href="https://www.behance.com/"} className="mt-8 md:ml-10 px-3 py-2 rounded-md bg-[#915EFF] font-semibold hover:bg-transparent hover:border-2">Get My Resume</button>
