...
const experiences = [
  {
    ...
    points: [
      ...
      "Added dynamic functionality with JavaScript.",
  ...
  },
  {
    ...
    date: "Phase 2",
    points: [
      "Mastered React and its core concepts.",
      "Styled UI components with Tailwind CSS.",
      "Managed state in React apps with Redux.",
      "Integrated APIs with React apps.",
    ],
  },
  {
    ...
    date: "Phase 3",
    points: [
      "Developed backend with Node.js and Express.",
      "Worked with MongoDB for database solutions.",
      "Built full-stack web applications with MERN stack.",
      "Implemented authentication and deployed apps.",
    ],
  },
  {
    ...
    date: "Phase 4",
    points: [
      "Started learning React Native for mobile apps.",
      "Learned about React Native components and navigation.",
      "Accessed device features using React Native APIs.",
      "Managed state and published React Native apps.",
    ],
  },
];
